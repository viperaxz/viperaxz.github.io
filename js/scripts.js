$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Valentin și Mihaela",

            // Event start date
            start: new Date('Jul 29, 2023 20:00'),
            ...
            end: new Date('Jul 30, 2023 06:00'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invitatie').val()) !== '466448384cc7421e8a48d629a2280a87'
            && MD5($('#invitatie').val()) !== '81dc9bdb52d04dc20036dbd8313ed055') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Scuze!</strong> Codul de invitație nu este corect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbx8vrTgVZ5qZ-WdfGFb0xhhU8DBYWLByVRClP6QH3BeGMbbsFiFtAjo2P3tOtUdQa2kMg/exec', data)
                .done(function (data) {
                    console.log(data);
